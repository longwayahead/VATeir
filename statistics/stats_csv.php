<?php
    ...
    foreach($out['cid'] as $controller_name => $z) {
      ...
      $fp = fopen('../uploads/ops/facility/'.date("Y_m", strtotime("- 1 month")) . '_controller_stats.csv', 'w');
      //file_put_contents(date("m.Y", strtotime("- 1 month")) . '_controller_stats.csv', $output);
