...
<div class="col-sm-3 col-md-2">
	...
	<ul class="well nav nav-list nav-list-vivid">
			...
			<li><a href="ts3server://ts.vateud.net?nickname=<?php echo ($user->isLoggedIn()) ? $user->data()->first_name . ' ' . $user->data()->last_name : '';?>&channel=%5Bcspacer0%5D%20vACC%20ROOMS%2FIreland%20vACC">Teamspeak</a></li>
			<li class="divider"></li>
			<br>
