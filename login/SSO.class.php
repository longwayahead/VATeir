...
class SSO {
     ...
     */
    public function sendToVatsim($string = null){
        ...
        if(!$string) {// redirect to the SSO login location, appending the token
    ...
    public function getLocLogin() {
        return $this->loc_login;
    }
    public function getTokenKey() {
        return $this->token->key;
    }
    public function buildURL() {
        return self::getBase() . self::getLocLogin() . self::getTokenKey();
    }
